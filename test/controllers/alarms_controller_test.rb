...
class AlarmsControllerTest < ActionController::TestCase
  ...
  test "should create alarm" do
    assert_difference('Alarm.count') do
      post :create, alarm: { am-pm: @alarm.am-pm, hour: @alarm.hour, minute: @alarm.minute, second: @alarm.second }
    end
  ...
  test "should update alarm" do
    patch :update, id: @alarm, alarm: { am-pm: @alarm.am-pm, hour: @alarm.hour, minute: @alarm.minute, second: @alarm.second }
    assert_redirected_to alarm_path(assigns(:alarm))
  end
